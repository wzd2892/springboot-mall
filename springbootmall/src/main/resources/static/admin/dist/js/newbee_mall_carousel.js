$(function () {
    $("#jqGrid").jqGrid({
        url: '/api/v1/pri/admin/carousels/list',
        datatype: "json",
        colModel: [
...
//     }
//     //请求数据
//     $.get("/api/v1/pri/admin/carousels/info/" + id, function (r) {
...
$('#saveButton').click(function () {
    var redirectUrl = $("#redirectUrl").val();      // 重定向的url值获取
    var carouselRank = $("#carouselRank").val();    // rank值获取
    var carouselUrl = $('#carouselImg')[0].src;     // 图片的src获取
    var data = {
        "carouselUrl": carouselUrl,
        "carouselRank": carouselRank,
        "redirectUrl": redirectUrl
    };
    var url = '/api/v1/pri/admin/carousels/save';
    var id = getSelectedRowWithoutAlert();
    if (id != null) {
        url = '/api/v1/pri/admin/carousels/update';
        data = {
            "carouselId": id,
            "carouselUrl": carouselUrl,
            "carouselRank": carouselRank,
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: "/api/v1/pri/admin/carousels/delete",
                    contentType: "application/json",
