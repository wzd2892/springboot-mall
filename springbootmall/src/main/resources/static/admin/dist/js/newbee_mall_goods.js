$(function () {
    $("#jqGrid").jqGrid({
        url: '/api/v1/pri/admin/goods/list',
        datatype: "json",
        colModel: [
...
function editGoods() {
    ...
    window.location.href = "/api/v1/pri/admin/goods/edit/" + id;
}
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "PUT",
                    url: "/api/v1/pri/admin/goods/status/0",
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "PUT",
                    url: "/api/v1/pri/admin/goods/status/1",
                    contentType: "application/json",
                    data: JSON.stringify(ids),
                    success: function (r) {
                        if (r.code == 200) {
