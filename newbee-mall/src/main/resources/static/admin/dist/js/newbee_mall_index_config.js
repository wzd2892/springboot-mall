$(function () {
    ...
    $("#jqGrid").jqGrid({
        url: '/api/v1/pri/admin/indexConfigs/list?configType=' + configType,
        datatype: "json",
        colModel: [
...
$('#saveButton').click(function () {
    ...
    if (!validCN_ENString2_18(configName)) {
        ...
        var url = '/api/v1/pri/admin/indexConfigs/save';
        var id = getSelectedRowWithoutAlert();
        if (id != null) {
            url = '/api/v1/pri/admin/indexConfigs/update';
            data = {
                "configId": id,
                "configName": configName,
                "configType": configType,
    ...
    swal({
        ...
        dangerMode: true,
            ...
            if (flag) {
                $.ajax({
                    type: "POST",
                    url: "/api/v1/pri/admin/indexConfigs/delete",
                    contentType: "application/json",
